...
<html>
    <head>
        <title>Profil Koordinator Relawan</title>
    ...
    <body>
        ...
        <tr><td>Terdaftar Sebagai Koordinator</td><td><?php 
             ...
             ?></td></tr>
	    <tr><td></td><td>
        <a href="<?php echo site_url('user/relawan/update_relawan/'.$this->session->userdata('id')) ?>" class="btn btn-primary">Update</button>
        <a href="<?php echo site_url('user/dasbor_relawan') ?>" class="btn btn-default">Cancel</button></td></tr>
	</table>
    </body>
</html>